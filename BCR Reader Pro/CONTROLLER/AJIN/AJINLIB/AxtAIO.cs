...
//========== Initilize/Close =========================================================================
    [DllImport("AxtLib.dll")] public static extern bool InitializeAIO();
    ...
    [DllImport("AxtLib.dll")] public static extern bool AIOwrite_dac(short nChannelNo, double dVolt);                              // D/A 출력
